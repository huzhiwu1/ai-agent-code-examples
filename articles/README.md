...
| slug                        | 代码    | 飞书链接                                                                       |
| --------------------------- | ------- | ------------------------------------------------------------------------------ |
| multi-agent-supervisor      | ✅ src/ | [多 Agent 编排](https://my.feishu.cn/docx/TcU1dAmLnoqyg5xectYcLUXun7d)         |
| mcp-tools                   | ✅ src/ | [MCP 协议](https://my.feishu.cn/docx/Q3RBdocckoltk8xHXeMcFnNVnic)              |
| mcp-server-guide            | ✅ src/ | [MCP Server 编写](https://my.feishu.cn/docx/KZF3dIZngoghyMxSGiicl6wBn4g)       |
| agent-observability         | ✅ src/ | [Agent 观测评估](https://my.feishu.cn/docx/YJm7dfqYho6DDWxS7hScu6qznkg)        |
| agentic-rag                 | ✅ src/ | [Agentic RAG](https://my.feishu.cn/docx/WUbedtQb0oIGcQxeU25cGg9Sn7g)           |
| agent-planning              | ✅ src/ | [Plan-and-Execute](https://my.feishu.cn/docx/IN0Td6b5NoaCHDxcmeFc6QRpnwh)      |
| context-eng                 | ✅ src/ | [上下文工程](https://my.feishu.cn/docx/J73XdzSQ4oYjqXxBSQzcquUvn6b)            |
| agent-memory                | ✅ src/ | [Agent 记忆管理](https://my.feishu.cn/docx/DkcDdigcTo4fqHx0BS4clkXcn0d)        |
...
| slug                 | 代码    | 说明                                                            |
| -------------------- | ------- | --------------------------------------------------------------- |
| agent-token-budget   | ✅ src/ | Token 预算/成本控制，大纲在 ai-agent-knowledge/outline-token.md |
| agent-pg-persistence | ✅ src/ | PG 持久化，大纲在 ai-agent-knowledge/outline-pg-agent.md        |
| mcp-adapters         | ✅ src/ | MCP 全链路演示，mcp-tools 的补充素材                            |
